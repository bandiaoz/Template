...
int main() {
    OY::DSUTable<true> dsu(10);
    dsu.merge_by_size(1, 2);
    dsu.merge_by_size(3, 4);
    dsu.merge_by_size(5, 6);
    dsu.merge_by_size(7, 8);
    dsu.merge_by_size(1, 3);
    dsu.merge_by_size(5, 7);
    dsu.merge_by_size(1, 5);
    return 0;
}