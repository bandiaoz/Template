...
namespace OY {
    namespace AdjDiff2D {
        ...
        public:
             ...
             */
            void add(size_type r1, size_type r2, size_type c1, size_type c2, value_type inc) { 
                r2--, c2--;
                _auto_to_difference(), _plus(r1, c1, inc), _minus(r1, c2 + 1, inc), _minus(r2 + 1, c1, inc), _plus(r2 + 1, c2 + 1, inc); 
            }
            /**
