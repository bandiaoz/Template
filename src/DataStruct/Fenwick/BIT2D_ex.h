...
/**
 * @brief 二维树状数组
 * @example OY::BIT2DEX::Tree<Tp> fen2d(row, column);
 */
namespace OY {
    namespace BIT2DEX {
        ...
        public:
            ...
            /**
             * @brief 对区间 `[row1, row2) x [column1, column2)` 增加 `inc`
             * @param row1 
             * @param row2 
             * @param column1 
             * @param column2 
            ...
            /**
             * @brief 对区间 `[row1, row2) x [column1, column2)` 求和
             * @param row1 
             * @param row2 
             * @param column1 
             * @param column2 
            ...
            Tp query(size_type row1, size_type row2, size_type column1, size_type column2) const { 
                return presum(row2, column2) + presum(row1, column1) - presum(row2, column1) - presum(row1, column2); 
            }
            Tp query_all() const { return presum(m_row, m_column); }
        };
