...
namespace OY {
    namespace SEGBIT {
        ...
        /**
         * @brief 满足交换律和结合律的二元运算
         * @tparam Tp 值类型
         * @tparam Identity 幺元
         * @tparam Operation 聚合函数
         */
        ...
        /**
         * @brief 满足交换律和结合律的二元运算，且有逆元
         * @tparam Tp 值类型
         * @tparam Identity 幺元
         * @tparam Operation 聚合函数
         * @tparam Inverse 返回逆元，从而可以进行子矩阵的值计算
         */
        ...
        public:
            ...
            /**
             * @brief 查询第 `i` 行第 `[column1, column2)` 列的前缀和
             */
            ...
            /**
             * @brief 查询第 `[row1, row2)` 行第 `[column1, column2)` 列的区间和
             */
            ...
            /**
             * @brief 查询第 `[row1, row2)` 行第 `j` 列的第 `k` 小值，第二维表示值域
             * @note 可以表述为，找到最小的列号 `c`，使得 `query(row1, row2, 0, c + 1) >= k + 1`
             */
