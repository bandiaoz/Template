...
namespace OY {
    namespace BFS {
        ...
        struct Solver {
            ...
            /**
             * @brief 设置 `i` 到 `source` 的距离为 `dis`，方案数为 `cnt`
             * @note 一般用于设置源点
             */
